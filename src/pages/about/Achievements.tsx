...
const ACHIEVEMENTS: Array<{
  ...
  {
    icon: TrophyIcon,
    title: "1st Place — Dev Up Rising Frontend Development",
    source: "Algobash",
    year: "Aug 2023",
    tone: "treasure",
  },
  {
    icon: MedalIcon,
    title: "Top 10 Warriors — Code Run Frontend Warriors",
    source: "Algobash",
    year: "Dec 2022",
    tone: "sunset",
  },
  {
    icon: MedalIcon,
    title: "3rd Place — Competitive Programming Dimas-TI AMLI 2022",
    source: "Asosiasi MIPA LPTK Indonesia",
    year: "Jun 2022",
    tone: "info",
  },
  {
    icon: SparklesIcon,
    title: "Bank Indonesia Scholarship Awardee 2022",
  ...
  {
    icon: TrophyIcon,
    title: "1st Place — Competitive Programming DoIt 2021",
    source: "Universitas Singaperbangsa",
    year: "Jun 2021",
    tone: "treasure",
  },
];
