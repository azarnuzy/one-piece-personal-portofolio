...
import { getProjectDetail, getProjectV2, PROJECT_DETAILS } from "./data";
    ...
    return (
      <div className="relative flex flex-1 items-center">
        <div className="z-10 max-w-[820px] flex-1 px-4 pb-8 md:px-8 md:pb-10">
          ...
          >
            <TitleWithHighlight title={v2.hero.title} highlight={v2.titleHighlight ?? ""} />
          </motion.h1>
