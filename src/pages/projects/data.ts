...
export const PROJECTS_V2: ProjectV2[] = [
  ...
  },
  {
    id: "cetakkita",
    category: "web",
    thumbnailImage: "/thumbnail-project/project-percetakan.png",
    titleHighlight: "AI-Assisted Printing Service Landing Page",
    hero: {
      title: "CetakKita: Modern Printing Service Landing Page",
      description:
    ...
    keyFeatures: [
      {
        name: "Conversion-Focused Hero Section",
        description:
      ...
      {
        name: "Interactive Service Filtering",
        description:
      ...
      {
        name: "Trust-Building Testimonial Carousel",
        description:
    ...
    techStack: [
      {
        name: "React 19",
        description:
          "Used as the core UI library for building a component-based, interactive landing page experience.",
      },
      {
        name: "TanStack Start",
        description:
          "Provides the application foundation with modern React routing, SSR-ready structure, and type-safe development patterns.",
      },
      {
        name: "TanStack Router",
        description: "Handles type-safe file-based routing for the main page structure.",
      },
      {
        name: "TypeScript",
        description:
          "Adds type safety across the React components, UI data structures, and shared utility code.",
      },
      {
        name: "Tailwind CSS 4",
        description:
          "Powers the custom visual system, responsive layout, spacing, typography, and light-dark theme tokens.",
      },
      {
        name: "shadcn/ui",
        description:
          "Provides reusable UI primitives such as buttons, cards, badges, accordions, and carousel-related components.",
      },
      {
        name: "Motion",
        description:
          "Adds entrance animations, loading transitions, staggered section reveals, and smooth interactive motion.",
      },
      {
        name: "Embla Carousel",
        description:
          "Supports the responsive testimonial carousel with looped navigation and pagination behavior.",
      },
      {
        name: "Lucide React",
        description:
          "Used for consistent iconography across navigation, feature labels, contact details, and service highlights.",
      },
    ],
    engineeringHighlights: [
      {
        point: "Single-Page Business Funnel",
        description:
      ...
      {
        point: "Responsive Visual Composition",
        description:
      ...
      {
        point: "Motion-Based User Experience",
        description:
      ...
      {
        point: "AI-Assisted Asset Pipeline",
        description:
    ...
    challenges: [
      {
        title: "Turning AI References into a Coherent UI",
        description:
      ...
      {
        title: "Maintaining Asset Consistency",
        description:
      ...
      {
        title: "Balancing Visual Richness and Business Clarity",
        description:
      ...
      {
        title: "Responsive Section Density",
        description:
    ...
    whatILearned: [
      {
        topic: "AI-Assisted Product Design",
        description:
      ...
      {
        topic: "Landing Page Information Architecture",
        description:
      ...
      {
        topic: "Modern React UI Composition",
        description:
      ...
      {
        topic: "Theme and Visual System Design",
        description:
    ...
    projectInfo: {
      category: "Business Landing Page / Printing Service",
      role: "Frontend Developer & AI-Assisted UI Builder",
      duration: "Personal Project",
      status: "Portfolio Ready",
    },
    highlights: [
    ...
    ctaContent: {
      livePreview:
        "Explore the modern printing service landing page and its WhatsApp-first ordering experience.",
      sourceCode:
        "Review the React, TanStack Start, Tailwind CSS, and AI-assisted implementation workflow behind the project.",
    },
  },
  {
    id: "hiazee",
