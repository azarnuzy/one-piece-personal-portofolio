  ...
  head: () => ({
    meta: [
      { title: "Blog — Azar" },
      {
        name: "description",
        content:
          "Sharing my journey, tutorials, insights, and experiences in the world of software engineering.",
      },
      ...
      { property: "og:title", content: "Blog — Azar" },
      {
        ...
        content: "Software Engineer insights, tutorials, and experiences by Azar.",
      },
